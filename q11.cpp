...
int main()
{
    ...
    cout<<"size of int is "<<sizeof(x)<<" "<<"and its pointer is "<<sizeof(p)<<endl;

    cout<<"size of char is "<<sizeof(y)<<" "<<"and its pointer is "<<sizeof(q)<<endl;

    cout<<"size of bool is "<<sizeof(z)<<" "<<"and its pointer is "<<sizeof(r)<<endl;

    cout<<"size of float is "<<sizeof(a)<<" "<<"and its pointer is "<<sizeof(s)<<endl;

    cout<<"size of double is "<<sizeof(b)<<" "<<"and its pointer is "<<sizeof(t)<<endl;
return 0;
}
