/* Write down your versions for the following functions: 
   Strcpy
   Strcat
   Strlen
   Strcmp
...
int main()
{
 ...
 //Implementation of strcpy function
    ...
    char str2[20];
    cout<<"Output of str2 which is copy of the string given:"<<endl;
    cout<<copy(str2,str)<<endl<<endl;
   ...
   //Implementation of strlen function
	...
	char *p=str;
    cout<<"Length of str (after strcat):"<<length(p)<<endl<<endl;
	...
	char str4[20];
	cout<<"Enter a string for comparison with initial string."<<endl;
	cin.getline(str4,20);
...
while(chr(p1,c)!=NULL)
{
	cout<<"Found at:"<<(chr(p1,c)-str+1)<<endl;
	p1=chr(p1,c)+1;
}
}
cout<<endl;
